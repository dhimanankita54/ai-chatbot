    ...
    return (
        <>
            <div className=" h-fit relative">
                ...
                <Button className="block md:hidden h-fit absolute top-0" onClick={() => setIsOpen(true)}>
                    <HiMenuAlt2 className="text-lg" />
                </Button>

                <Drawer open={isOpen} onClose={handleClose} className="bg-gray-900 drawer w-64 fixed md:hidden">
